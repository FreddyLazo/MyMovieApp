...
public class MovieResponses implements Parcelable {
    ...
    public static final Parcelable.Creator<MovieResponses> CREATOR = new Parcelable.Creator<MovieResponses>() {
        @Override
        public MovieResponses createFromParcel(Parcel source) {
            return new MovieResponses(source);
        }
